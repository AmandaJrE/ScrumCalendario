...
let viewController = {
   ...
   *
   * @param {click} clickEvent - Este parâmetro é passado automaticamente pelo
   * navegador quando a função é definida no 'onclick' do elemento.
   */
  ...
  /**
   * Esta função recebe como parâmetro uma outra função e sobrescreve o callback
   * Isso permite que, no app.js, seja definida uma função para ser executada
   * quando o botão for clicado.
   *
   * Esta função é o que ativa a rotina de regra de neǵocio, e não a parte visual.
   *
